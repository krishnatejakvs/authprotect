...
The system SHALL allow authorized users to create Projects under an Organization. A Project SHALL belong to exactly one Organization.

#### Scenario: Authorized user creates a project
- **WHEN** an authorized user submits a new Project request
- **THEN** the Project is created and associated with the current Organization
